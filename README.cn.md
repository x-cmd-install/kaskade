...
合计: **21,039** 行代码（覆盖前 5 种语言、共 **75** 个文件）。
...
- **Star**: 1,027 · **Fork**: 20 · **开放 issue**: 61 · **贡献者**: 3

## 累计统计

- **发布数**: 44 · **已合并 PR**: 60 · **开放 PR**: 0 · **已关闭 issue**: 54 · **开放 issue**: 7 · **提交数**: 566
...
在 [repology.org](https://repology.org/project/kaskade) 上共有 **4** 个发行版报告此项目。**1** 个 ✅ 已是最新上游版本，**1** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260913.yml` · 2026-09-13T04:57:30Z._
