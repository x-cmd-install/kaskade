...
- **Stars**: 1,026 · **Forks**: 20 · **Open issues**: 60 · **Contributors**: 3

## Totals (cumulative)

- **Releases**: 44 · **Merged PRs**: 57 · **Open PRs**: 0 · **Closed issues**: 53 · **Open issues**: 7 · **Commits**: 563
...
Reported by **4** distros on [repology.org](https://repology.org/project/kaskade). **1** are ✅ on the latest upstream release, **1** are ⚠️ on an older version.

| Distro | Version | Status |
|--------|---------|--------|
| Homebrew | `5.0.0` | ✅ latest |
...
_Snapshot: `data/card/260910.yml` · 2026-09-10T20:55:39Z._
